...
Feature: This feature will allow you do to all the calculator operations using parameters
  ...
  Scenario: The scenario is to calculate total bill amount
  ...
  Scenario: The scenario is to calculate total bill amount using Quantity
    Given I want to buy below items in given quantities
      | Coffee      | 2 | 20 |    
      | Burger      | 3 | 50 |    
      | garlicbread |1| 15 | 
